        ...
        <div className="col-md-5">
          <div className="form-area">  
              <form role="form">
                ...
                <div className="form-group">
                  <textarea value={this.state.subject} className="form-control" onChange={this.handleSubjectChange} type="textarea" id="subject" placeholder="Subject" maxlength="100" rows="3"></textarea>
                </div>

                <div clssName = "form-group">
                  <h4> 여기로 파일을 드래그 & 드롭 </h4>
                </div>
...
class ShowPost extends React.Component {
    constructor(props) {
      ...
      this.getDatePost = this.getDatePost.bind(this);
      this.state = {
        posts:[]
      };
    ...
    downloadPost(id){
      ...
      var self = this;
      axios({
        url: 'socrip4.kaist.ac.kr:3680/home',
        method: 'GET',
            ...
            <tbody>
              {
                this.state.posts.map(function(post,index) {
                   return <tr key={index} >
                            ...
                            <td>
                              <span onClick={this.downloadPost.bind(this,post._id)} className="glyphicon glyphicon-download-alt"></span>
                            </td>
                          </tr>
                }.bind(this))
              }
